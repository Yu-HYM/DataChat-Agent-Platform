...
import ast, operator, re, threading, os
import pymysql
...
def sql_query(sql: str, question: str = "") -> str:
    ...
    if effective_q and any(kw in effective_q for kw in DOC_KEYWORDS):
        try:
